...
type IGlobalStore with
    ...
    member store.Theme =
        store.CreateCVal(
            nameof store.Theme,
            MudTheme(
                PaletteDark = PaletteDark(Primary = "#1c6a5e", Secondary = "#477a49", Surface = "#0c0f14", Background = "#0a0b0e", HoverOpacity = 0.2),
                PaletteLight = PaletteLight(Primary = "#1c6a5e", Secondary = "#477a49", HoverOpacity = 0.3)
            )
        )
